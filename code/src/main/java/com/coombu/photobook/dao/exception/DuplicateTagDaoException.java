...
public class DuplicateTagDaoException extends Exception {
     ...
     * @param t
     */
    public DuplicateTagDaoException(Throwable t) {
        super(t);
    }
     ...
     * @param message
     */
    public DuplicateTagDaoException(String message) {
        super(message);
    }
     ...
     * @param t
     */
    public DuplicateTagDaoException(String message, Throwable t) {
        super(message, t);
    }
     ...
     * @param t
     */
    public DuplicateTagDaoException(String exceptionName, String className,
            Throwable t) {
