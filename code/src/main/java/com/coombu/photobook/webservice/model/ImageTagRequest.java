...
public class ImageTagRequest implements Serializable
{
	...
	public ImageTagRequest(long currentEventId, long imageId2, long eventSecurityId, long securityUserId2, String status) 
	{
		this.eventId = currentEventId;
		this.imageId = imageId2;
		this.eventSecurityUserId = eventSecurityId;
		this.securityUserId = securityUserId2;
		this.status = status;
	}
